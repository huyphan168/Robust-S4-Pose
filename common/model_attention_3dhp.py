...
class Attention3DHPModelBase(nn.Module):
    """
...
class Attention3DHPModelOptimized1f(Attention3DHPModelBase):
    """
    ...
    def set_bn_momentum(self, momentum):
        super().set_bn_momentum(momentum)
        self.set_KA_bn(momentum)
        self.set_expand_bn(momentum)
        self.set_dilation_bn(momentum)
